...
| 4 | The integers: divisibility, modular arithmetic, primes, Euclidean algorithm, GCD, solving congruence relations, Chinese remainder theorem, Diophantine equations |
| 5 | Induction and recursion: mathematical induction, recursively defined sequences, solving recurrence relations, characteristic polynomials |
| 6 | Principles of counting: inclusion-exclusion principle, sum and product rules, pigeonhole principle |
| 7 | Permutations and combinations: permutations, combinations, combinations with repetition, binomial theorem |
| 8 | Graphs: definitions, basic properties, isomorphism |
